...
contract MeetdAppEvent is MeetdAppEventVariables, Ownable {
    constructor(
        ...
        eventTotalTickets =
            eventRemainingTickets = _varInt[uint256(consVarInt.capacity)];
    }
    ...
    function updateEventDescription(string memory _eventDescription)
        public
        onlyOwner
    {
    ...
    function updateEventLocation(string memory _eventLocation)
        public
        onlyOwner
    {
    ...
    function updateEventTotalTickets(uint256 _eventTotalTickets)
        public
        onlyOwner
    {
        require(
    ...
    function buyTicket() public {
        require(
            eventAttendees[msg.sender] == false, "You already have a ticket"
        );
